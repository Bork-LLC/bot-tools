...
var app = (function () {
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			add_location(main, file$a, 4, 0, 48);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_prepend_slot_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "icon svelte-1nie0y2");
    			add_location(div, file$b, 54, 6, 1552);
    			attr_dev(span, "slot", "prepend");
    			set_style(span, "padding-right", "10px");
    			set_style(span, "padding-top", "5px");
    			add_location(span, file$b, 53, 5, 1478);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			append_dev(span, div);
    ...
    function create_prepend_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "icon svelte-1nie0y2");
    			add_location(div, file$b, 62, 6, 1750);
    			attr_dev(span, "slot", "prepend");
    			set_style(span, "padding-right", "10px");
    			set_style(span, "padding-top", "5px");
    			add_location(span, file$b, 61, 5, 1676);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			append_dev(span, div);
    ...
    function create_prepend_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "icon svelte-1nie0y2");
    			add_location(div, file$b, 70, 6, 1943);
    			attr_dev(span, "slot", "prepend");
    			set_style(span, "padding-right", "10px");
    			set_style(span, "padding-top", "5px");
    			add_location(span, file$b, 69, 5, 1869);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			append_dev(span, div);
    ...
    function create_prepend_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "icon svelte-1nie0y2");
    			add_location(div, file$b, 78, 6, 2135);
    			attr_dev(span, "slot", "prepend");
    			set_style(span, "padding-right", "10px");
    			set_style(span, "padding-top", "5px");
    			add_location(span, file$b, 77, 5, 2061);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			append_dev(span, div);
    ...
    // (42:2) <NavigationDrawer {mini} style="background-color: rgb(40,40,40);float: left ">
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(42:2) <NavigationDrawer {mini} style=\\\"background-color: rgb(40,40,40);float: left \\\">",
    		ctx
    	});
    ...
    function create_default_slot$5(ctx) {
    	...
    	navigationdrawer = new NavigationDrawer({
    			props: {
    				mini: /*mini*/ ctx[0],
    				style: "background-color: rgb(40,40,40);float: left ",
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$b, 29, 4, 730);
    			attr_dev(div0, "class", "iconb svelte-1nie0y2");
    			add_location(div0, file$b, 28, 3, 705);
    			...
    			add_location(img1, file$b, 32, 4, 826);
    			attr_dev(div1, "class", "iconb svelte-1nie0y2");
    			add_location(div1, file$b, 31, 3, 801);
    			...
    			add_location(img2, file$b, 35, 4, 933);
    			attr_dev(div2, "class", "iconb svelte-1nie0y2");
    			attr_dev(div2, "id", "close");
    			add_location(div2, file$b, 34, 3, 897);
    			attr_dev(div3, "id", "buttons");
    			attr_dev(div3, "class", "svelte-1nie0y2");
    			add_location(div3, file$b, 27, 2, 682);
    			attr_dev(div4, "id", "maintop");
    			attr_dev(div4, "class", "svelte-1nie0y2");
    			add_location(div4, file$b, 38, 2, 1017);
    			attr_dev(div5, "id", "topbar");
    			attr_dev(div5, "class", "svelte-1nie0y2");
    			add_location(div5, file$b, 26, 1, 661);
    			attr_dev(div6, "id", "wrapper");
    			set_style(div6, "float", "right");
    			set_style(div6, "width", "calc(100% - 56px)");
    			set_style(div6, "height", "100%");
    			add_location(div6, file$b, 86, 2, 2272);
    			set_style(div7, "height", "100%");
    			attr_dev(div7, "class", "d-inline-block");
    			attr_dev(div7, "id", "nav");
    			add_location(div7, file$b, 40, 1, 1053);
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(navigationdrawer, div7, null);
    			append_dev(div7, t4);
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(div7, "mouseenter", /*enter*/ ctx[1], false, false, false),
    					listen_dev(div7, "mouseleave", /*leave*/ ctx[2], false, false, false)
    				];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(26:0) <MaterialApp theme=\\\"dark\\\">",
    		ctx
    	});
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$b, create_fragment$b, safe_not_equal, { name: 3 });
